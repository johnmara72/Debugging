...
Messages.quit = "Θέλετε αλήθεια να " \
    "πραγματοποιήσετε έξοδο;"
Messages.username_prompt = "εισάγετε το userid σας"
Messages.enter_password = "εισάγετε κωδικό"
Messages.enter_import_password = "εισάγετε τον κωδικό " \
    "εισαγωγής σας"
Messages.incorrect_password = "λάθος κωδικός"
Messages.repeat_password = "επαναλάβετε τον κωδικό " \
    "σας"
Messages.passwords_differ = "οι κωδικοί δεν " \
    "ταιριάζουν"
Messages.installation_finished = "Επιτυχής " \
    "εγκατάσταση"
Messages.cat_dir_exisits = "Ο φάκελος {} υπάρχει " \
    "ήδη· μερικά αρχεία του μπορεί να " \
    "αντικατασταθούν."
Messages.cont = "Συνέχεια;"
Messages.nm_not_supported = "Αυτή η έκδοση Network Manager " \
    "δεν υποστηρίζεται"
Messages.cert_error = "Το αρχείο πιστοποιητικού " \
    "δε βρέθηκε, αυτό δείχνει για σφάλμα " \
    "στο CAT"
Messages.unknown_version = "Άγνωστη έκδοση"
Messages.dbus_error = "Πρόβλημα σύνδεσης DBus, ένα " \
    "sudo μπορεί να βοηθήσει"
Messages.yes = "Ν"
Messages.no = "Ο"
Messages.p12_filter = "αρχείο προσωπικού " \
    "πιστοποιητικού (p12 or pfx)"
Messages.all_filter = "Όλα τα αρχεία"
Messages.p12_title = "αρχείο προσωπικού " \
    "πιστοποιητικού (p12 or pfx)"
Messages.save_wpa_conf = "Η παραμετροποίηση του " \
    "Network Manager απέτυχε, αλλά μπορούμε να " \
    "παράξουμε ένα αρχείο ρύθμισης wpa_supplicant " \
    "αν το επιθυμείτε. Να γνωρίζετε ότι ο " \
    "κωδικός σύνδεσής σας θα αποθηκευτεί " \
    "σε αυτό το αρχείο χωρίς " \
    "κρυπτογράφηση."
Messages.save_wpa_confirm = "Γράψτε το αρχείο"
Messages.wrongUsernameFormat = "Σφάλμα: Το όνομα " \
    "χρήστη σας πρέπει να είναι στη μορφή " \
    "'xxx@institutionID' π.χ. 'john@example.net'!"
Messages.wrong_realm = "Σφάλμα: το όνομα χρήστη " \
    "σας πρέπει να είναι στη μορφή 'xxx@{}'. " \
    "Παρακαλώ εισάγετε το όνομα χρήστη στη " \
    "σωστή μορφή."
Messages.wrong_realm_suffix = "Σφάλμα: Το όνομα " \
    "χρήστη σας πρέπει να είναι στη μορφή " \
    "'xxx@institutionID' και να λήγει σε '{}'. Παρακαλώ " \
    "εισάγετε το όνομα χρήστη στη σωστή " \
    "μορφή."
Messages.user_cert_missing = "το αρχείο προσωπικού " \
    "πιστοποιητικού δεν βρέθηκε"
Config.instname = "Αλεξάνδρειο Τεχνολογικό " \
    "Εκπαιδευτικό Ιδρυμα Θεσσαλονίκης " \
    "(ΑΤΕΙΘ)"
Config.profilename = "ATEITH eduroam"
Config.url = "η τοπική σας σελίδα " \
    "υποστήριξης για eduroam®"
Config.email = "noc@teithe.gr"
Config.title = "eduroam CAT"
Config.server_match = "eduroam.teithe.gr"
Config.eap_outer = "TTLS"
Config.eap_inner = "PAP"
Config.init_info = "Αυτό το πρόγραμμα " \
    "εγκατάστασης έχει προετοιμαστεί για " \
    "{0}\n\nΠερισσότερες πληροφορίες και " \
    "σχόλια:\n\nEMAIL: {1}\nWWW: {2}\n\nΤο πακέτο " \
    "εγκατάστασης δημιουργήθηκε με " \
    "λογισμικό από το GEANT project."
Config.init_confirmation = "Αυτό το πρόγραμμα " \
    "εγκατάστασης θα λειτουργήσει σωστά " \
    "μόνο αν είστε μέλος του {0}."
Config.user_realm = "teithe.gr"
Config.ssids = ['eduroam']
Config.del_ssids = []
Config.servers = ['DNS:eduroam.teithe.gr']
Config.use_other_tls_id = False
Config.anonymous_identity = "anonymous@teithe.gr"
Config.tou = ""
